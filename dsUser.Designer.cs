...
namespace AspNetCoreRDLC.dsUserTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([FirstName], [LastName], [Email], [Phone]) VALUES (@Fi" +
                "rstName, @LastName, @Email, @Phone)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-8Q1K6NS\\MSSQLSERVERDB;Initial Catalog=TestRDLC;Integrated Sec" +
                "urity=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT FirstName, LastName, Email, Phone FROM dbo.Users";
